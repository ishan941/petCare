...
//                                           IconButton(
//                                               onPressed: () {
//                                                _showAlertDialog(context, shopProvider, index, shopProvider.cartItemsList[index].id!);
//                                               },
...
//     );
//   }
//   void _showAlertDialog(BuildContext context, ShopProvider shopProvider, int index, String id) {
//     var cartItems = shopProvider.cartItemsList[index];
//     showDialog(
//       context: context,
//       builder: (

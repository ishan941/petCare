...
class EditDonate extends StatefulWidget {
  ...
  @override
  State<EditDonate> createState() => _EditShopState();
}

class _EditShopState extends State<EditDonate> {
  @override
  void initState() {
                                          ...
                                          child: Column(
                                            children: [
                                              Image.network(sellingPetProvider
                                                      ...
                                                      .imageUrl ??
                                                  " "),
                                              Text(sellingPetProvider.donatePetList[index].petName ?? ""),
                                              Text(sellingPetProvider.donatePetList[index].petAge ?? ""),
                                              Text(sellingPetProvider.donatePetList[index].petWeight ?? ""),
                                            ],
                                          )),
                                    ),
                                  ),

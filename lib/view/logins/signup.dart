...
class _SignUpPageState extends State<SignUpPage> {
          ...
          builder: (context, petcareProvider, child) => SingleChildScrollView(
            child: Column(
              children: [
                Stack(
                  children: [
                    ui(context, signUpProvider, petcareProvider),
  ...
  Widget loader(SignUpProvider signUpProvider) {
    return signUpProvider.signUpUtil == StatusUtil.loading
        ? Helper.backdropFilter(context)
        : SizedBox();
  }

  Widget ui(BuildContext context, SignUpProvider signUpProvider,

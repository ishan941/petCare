...
class _LoginPageState extends State<LoginPage> {
        ...
        child: Consumer<SignUpProvider>(
          builder: (context, signUpProvider, child) =>
            ...
            SingleChildScrollView(
              child: Column(
                children: [
                  login(context, signUpProvider, petcareProvider),
                  loader(signUpProvider)
                ],
              ),
            ),
          ),
  ...
  Widget loader(SignUpProvider signUpProvider) {
    return signUpProvider.loginUtil == StatusUtil.loading
        ? Helper.backdropFilter(context)
        : SizedBox();
  }

  Widget login(BuildContext context, SignUpProvider signUpProvider, PetCareProvider petcareProvider) {
    return Form(
                  key: _formKey,
                  child: Column(
                                    ...
                                    onPressed: () async {
                                      if (_formKey.currentState!.validate()) {
                                        await signUpProvider
                                            .userLoginDetails();
                                            if(signUpProvider.loginUtil == StatusUtil.loading){
                                              Helper.backdropFilter(context);
                                            }
                        ...
                        onTap: () async {
                          ...
                          if (user != null) {
                            Navigator.pushAndRemoveUntil(
                                ...
                                (route) => false);
                            signUpProvider.SaveValueToSharedPreference(true);
                          } else {

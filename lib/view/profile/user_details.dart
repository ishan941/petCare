...
import 'package:project_petcare/view/profile/mypet_more.dart';
import 'package:project_petcare/view/profile/verifications/verifyYourAccount_1.dart';
...
class _MyProfileState extends State<MyProfile> {
  ...
  Widget _myPet( SellingPetProvider sellingPetProvider) {
    return ClipRRect(
              ...
              child: Row(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => MyPetsMore()));
                    },
                    child: Text(
                      "View More",
                      style: bottomTxs,

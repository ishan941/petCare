...
const verifyEmailApi = "verifyEmail";
const newpasswordApi = "newPassword";
...
const getUserPhoneApi = "userPhone";
const getServiceByNameApi = "getServiceByName/{key}";
const getCategoryByIdUrl = "getCategoryById/{id}" ;
const getPaymentsDetailsApi = "showOrder";
const getMyPaymentsApi = "showOrderByUser";
